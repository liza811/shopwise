...
public class CosmetiqueAdapter extends RecyclerView.Adapter<CosmetiqueAdapter.CosmetiqueAdapterViewHolder>{
    ...
    public CosmetiqueAdapter(List<ArticleOccasionModel> articleModelList, Context context, RecyclerViewInterface recyclerViewInterface) {
    ...
    @NonNull
    @Override
    public CosmetiqueAdapter.CosmetiqueAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.article,viewGroup,false);
        return new CosmetiqueAdapter.CosmetiqueAdapterViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CosmetiqueAdapter.CosmetiqueAdapterViewHolder holder, int position) {
    ...
    public class CosmetiqueAdapterViewHolder extends RecyclerView.ViewHolder{
        ...
        public CosmetiqueAdapterViewHolder(@NonNull View itemView) {
            super(itemView);
