...
public class VetementAdapter extends RecyclerView.Adapter<VetementAdapter.VetementAdapterViewHolder>{
    ...
    public VetementAdapter(List<ArticleOccasionModel> articleModelList, Context context, RecyclerViewInterface recyclerViewInterface) {
    ...
    @NonNull
    @Override
    public VetementAdapter.VetementAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.article,viewGroup,false);
        return new VetementAdapter.VetementAdapterViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VetementAdapter.VetementAdapterViewHolder holder, int position) {
    ...
    public class VetementAdapterViewHolder extends RecyclerView.ViewHolder{
        ...
        public VetementAdapterViewHolder(@NonNull View itemView) {
            super(itemView);
